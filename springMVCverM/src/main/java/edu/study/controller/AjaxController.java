...
public class AjaxController {
	 ...
	 * @ResponseBody
	 * 
	 * @RequestMapping(value="ajaxTest1.do", method=RequestMethod.GET) public String
	 * ajaxTest1(String test1, String test2) { return test1+"_"+test2+"_ajax!!";
	 * //data1_data2_ajax!! }
	 */
	@ResponseBody
	@RequestMapping(value="ajaxTest1.do", method=RequestMethod.POST, produces = "application/text; charset=utf8")
